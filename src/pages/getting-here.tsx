  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        ...
        <p>
          Caribbean Cruisin offers a daily ferry service from Provo to North Caicos operating out of Walkin Marina.
          ...
          bear in mind the last ferry leaves no later than 5pm. Tickets are $55 roundtrip and can be purchased online
        ...
        <p>
          ...
          time from one of our preferred car rental companies, who will meet you upon arrival at Sandy Point.
        </p>
      </div>
