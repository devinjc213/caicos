  ...
  return (
    <div>
      <div className={styles.header}>
        <Image
          src='/assets/attractions-header.jpg'
          width='1024'
          height='768'
          alt='header'
      ...
      <div className={styles.main}>
        ...
        />
        <Attraction
          imageSrc='/assets/horsestable.jpg'
